...
class ActivatePinPage extends StatefulWidget {
  const ActivatePinPage({super.key});

  @override
  State<ActivatePinPage> createState() => _ActivatePinPageState();
}

class _ActivatePinPageState extends State<ActivatePinPage> {
                            ...
                            child: Column(
                              children: [
                                PinField(
                                  ...
                                  validator: (_) => cubit.pinValidator(_),
                                ),
                                const Space(
                                  height: 40,
                                ),
                                    ...
                                    SizedBox(
                                      ...
                                      child: CustomButton(
                                        title: Text(
                                          'إعادة الإرسال',
                                          style:
                                              AppTheme.Font15PrimaryBoldStyle(),
                                        ),
                                        onPressed: () =>
                                            cubit.onDoneclick(context),
                                        hasBordered: true,
                                      ),
                                    ),
                                  ],
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        loginText,
                                        style:
                                            AppTheme.Font18PrimaryBoldStyle(),
                                      ),
                                      Text(
                                        haveAccountText,
                                        style:
